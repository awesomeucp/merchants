...
export function MerchantForm({ categories, capabilities, paymentMethods }: MerchantFormProps) {
  ...
  useEffect(() => {
    ...
    const domain = normalizedUrl.replace('https://', '').replace('http://', '').split('/')[0];
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-zinc-700 text-white rounded-md hover:bg-zinc-800 transition-colors text-sm font-medium"
              >
                Download
              </button>
            </div>
          ...
          <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-950 rounded-md">
            ...
            <ol className="text-sm text-blue-800 dark:text-blue-200 space-y-1 list-decimal list-inside">
              ...
              <li>Save it as <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">{formData.slug || 'your-store'}.json</code></li>
              <li>Add it to <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">data/merchants/</code></li>
